...
function Projects() {
  ...
  return (
    <div>
      <h1 id='projectsTitleText'>Projects</h1>
      <div className="card-group">
        <div className="card">
          ...
          <a href="https://github.com/nainoaktv/cyborg-game" rel="noreferrer"  target="_blank" className="repolink">Github Repo</a>
          <a href="https://nainoaktv.github.io/cyborg-game/" rel="noreferrer"  target="_blank" className="siteLink">Visit Site Here</a>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card-footer">
          <a href="https://github.com/nainoaktv/anime-tracker" rel="noreferrer"  target="_blank" className="repolink">Github Repo</a>
          <a href="https://anitrack.herokuapp.com/" rel="noreferrer"  target="_blank" className="siteLink">Visit Site Here</a>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <h5 className="card-title"><em>"Generous"</em></h5>
